...
import 'package:bedrockxunderground/Warning.dart';
...
String platformBrowser = 'not detected';
String platform = 'not detected';
bool mobile = true;
bool redirect = false;
void launchExternalBrowserJS(String url) {
  try {
    // Attempt to use url_launcher first
...
void forceOpenExternalBrowser(String url) {
  final Uri uri = Uri.parse(url);

  // Android: Use intent:// to open Chrome externally
  if (html.window.navigator.userAgent.toLowerCase().contains("android")) {
    html.window.location.href =
        "intent://$url#Intent;package=com.android.chrome;scheme=https;end;";
  }
  // iOS: Use JavaScript `window.open`
  else if (html.window.navigator.userAgent.toLowerCase().contains("iphone") ||
      html.window.navigator.userAgent.toLowerCase().contains("ipad")) {
    html.window.open(url, "_system"); // Forces Safari
  }
  // Default: Open normally in a new tab
  else {
    html.window.open(url, "_system");
  }
}
...
void main() async {
  ...
  // Redirect to external browser if inside Instagram, LINE, WhatsApp, or Facebook
  WidgetsBinding.instance.addPostFrameCallback((_) {
    if (WebDetect.isInAppBrowser()) {
      print(WebDetect.isInAppBrowser);
      // forceOpenExternalBrowser("https://uckilter.socialclimbersapp.com/");
      // print(redirect);
      redirect = true;
      // _redirectToExternalBrowser(
      //     Uri.parse("https://uckilter.socialclimbersapp.com/"));
      // _launchExternalBrowser("https://uckilter.socialclimbersapp.com/");
    } else {
      print(redirect);
    }
  });
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Row(
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              " Underground Climb",
                                                                              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12, color: Colors.cyan[300]),
                                                                            ),
                                                                          ],
                                                                        ),
                                                                        const SizedBox(
...
class WebDetect {
  static bool isInAppBrowser() {
    ...
    platform = userAgent;
    switch (userAgent) {
      case String ua when ua.contains("instagram"):
        platformBrowser = "Instagram browser detected";
        print(platformBrowser);
        return userAgent.contains("instagram") ||
            userAgent.contains("fbav") || // Facebook app browser
            userAgent.contains("fban") || // Facebook new versions
            userAgent.contains("line") ||
            userAgent.contains("whatsapp");
      case String ua when ua.contains("fbav"):
        platformBrowser = "Facebook app browser detected";
        print(platformBrowser);
        return userAgent.contains("instagram") ||
            userAgent.contains("fbav") || // Facebook app browser
            userAgent.contains("fban") || // Facebook new versions
            userAgent.contains("line") ||
            userAgent.contains("whatsapp");
      case String ua when ua.contains("fban"):
        platformBrowser = "Facebook new versions browser detected";
        print(platformBrowser);
        return userAgent.contains("instagram") ||
            userAgent.contains("fbav") || // Facebook app browser
            userAgent.contains("fban") || // Facebook new versions
            userAgent.contains("line") ||
            userAgent.contains("whatsapp");
      case String ua when ua.contains("line"):
        platformBrowser = "LINE browser detected";
        print(platformBrowser);
        return userAgent.contains("instagram") ||
            userAgent.contains("fbav") || // Facebook app browser
            userAgent.contains("fban") || // Facebook new versions
            userAgent.contains("line") ||
            userAgent.contains("whatsapp");
      case String ua when ua.contains("whatsapp"):
        platformBrowser = "WhatsApp browser detected";
        print(platformBrowser);
        return userAgent.contains("instagram") ||
            userAgent.contains("fbav") || // Facebook app browser
            userAgent.contains("fban") || // Facebook new versions
    ...
    // Detect Instagram, Facebook, LINE, WhatsApp in-app browsers
    return userAgent.contains("instagram") ||
        userAgent.contains("fbav") || // Facebook app browser
        userAgent.contains("fban") || // Facebook new versions
        userAgent.contains("line") ||
